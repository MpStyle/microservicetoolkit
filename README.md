...
### Package Manager
```
Install-Package microservice.toolkit.core -Version 0.7.0
```

### .NET CLI
```
dotnet add package microservice.toolkit.core --version 0.7.0
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.core" Version="0.7.0" />
```

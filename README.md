...
### Package Manager
```
Install-Package microservice.toolkit.core -Version 0.4.7
```

### .NET CLI
```
dotnet add package microservice.toolkit.core --version 0.4.7
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.core" Version="0.4.7" />
```

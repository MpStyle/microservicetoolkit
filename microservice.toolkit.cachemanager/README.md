...
### Package Manager
```
Install-Package microservice.toolkit.cachemanager -Version 0.4.3
```

### .NET CLI
```
dotnet add package microservice.toolkit.cachemanager --version 0.4.3
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.cachemanager" Version="0.4.3" />
```

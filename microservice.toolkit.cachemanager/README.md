...
### Package Manager
```
Install-Package microservice.toolkit.cachemanager -Version 0.4.4
```

### .NET CLI
```
dotnet add package microservice.toolkit.cachemanager --version 0.4.4
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.cachemanager" Version="0.4.4" />
```

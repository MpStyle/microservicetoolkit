...
public static class DbDataReaderExtension
{
    ...
    public static async Task<string?> GetNullableStringAsync(this DbDataReader reader, int ordinal)
    {
    ...
    public static async Task<long?> GetNullableInt64Async(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetInt64(ordinal);
    }
    ...
    public static async Task<int?> GetNullableInt32Async(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetInt32(ordinal);
    }
    ...
    public static async Task<short?> GetNullableInt16Async(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetInt16(ordinal);
    }
    ...
    public static async Task<bool?> GetNullableBooleanAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetBoolean(ordinal);
    }
    ...
    public static async Task<byte?> GetNullableByteAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetByte(ordinal);
    }
    ...
    public static async Task<DateTime?> GetNullableDateTimeAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetDateTime(ordinal);
    }
    ...
    public static async Task<decimal?> GetNullableDecimalAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetDecimal(ordinal);
    }
    ...
    public static async Task<double?> GetNullableDoubleAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetDouble(ordinal);
    }
    ...
    public static async Task<float?> GetNullableFloatAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetFloat(ordinal);
    }
    ...
    public static async Task<Guid?> GetNullableGuidAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetGuid(ordinal);
    }
    ...
    public static async Task<object?> GetNullableValueAsync(this DbDataReader reader, int ordinal)
    {
        return await reader.IsDBNullAsync(ordinal) ? null : reader.GetValue(ordinal);
    }

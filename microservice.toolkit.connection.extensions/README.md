...
### Package Manager
```
Install-Package microservice.toolkit.connection.extensions -Version 2.0.0
```

### .NET CLI
```
dotnet add package microservice.toolkit.connection.extensions --version 2.0.0
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.connection.extensions" Version="2.0.0" />
```

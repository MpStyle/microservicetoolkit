...
### Package Manager
```
Install-Package microservice.toolkit.connectionmanager -Version 0.11.0
```

### .NET CLI
```
dotnet add package microservice.toolkit.connectionmanager --version 0.11.0
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.connectionmanager" Version="0.11.0" />
```

...
### Package Manager
```
Install-Package microservice.toolkit.messagemediator -Version 0.6.0
```

### .NET CLI
```
dotnet add package microservice.toolkit.messagemediator --version 0.6.0
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.messagemediator" Version="0.6.0" />
```

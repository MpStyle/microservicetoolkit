...
### Package Manager
```
Install-Package microservice.toolkit.migrationmanager -Version 0.9.1
```

### .NET CLI
```
dotnet add package microservice.toolkit.migrationmanager --version 0.9.1
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.migrationmanager" Version="0.9.1" />
```

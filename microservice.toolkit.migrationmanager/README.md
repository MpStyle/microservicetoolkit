...
### Package Manager
```
Install-Package microservice.toolkit.migrationmanager -Version 1.0.0
```

### .NET CLI
```
dotnet add package microservice.toolkit.migrationmanager --version 1.0.0
```

### Package Reference
```
<PackageReference Include="microservice.toolkit.migrationmanager" Version="1.0.0" />
```

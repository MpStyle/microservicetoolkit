using mpstyle.microservice.toolkit.book;
using mpstyle.microservice.toolkit.book.messagemediator;
...
namespace mpstyle.microservice.toolkit.test.book.messagemediator
{
